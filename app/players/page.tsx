...
export default function PlayersPage() {
  ...
  // Use static player data which has complete stats
  useEffect(() => {
    console.log('Loading popular players with complete stats from static data...');
    // Static data already has all stats including 3PT%, FT%, all shooting stats
    setPopularPlayersWithStats(POPULAR_PLAYERS); // Show all popular players
