...
export const POPULAR_PLAYERS: PlayerInfo[] = [
  ...
  { id: 3945274, name: 'Luka Dončić', teamTricode: 'DAL', position: 'G', jerseyNumber: '77', height: '6-7', weight: '230', ppg: 33.1, rpg: 8.9, apg: 9.5, fgm: 11.2, fga: 23.5, fgPct: 47.7, fg3m: 3.8, fg3a: 10.3, fg3Pct: 36.9, ftm: 6.9, fta: 8.6, ftPct: 80.2, mpg: 37.4 },
